...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =
{
  ...
  //|--------------+--------------+--------------+--------------+--------------+--------------+--------------|    |--------------+--------------+--------------+--------------+--------------+------------------+------------------|
                                                                        KC_TRNS,         MO(5),       KC_TRNS,           KC_SPACE,       KC_KP_0,       KC_KP_0
  //                                                            |--------------+--------------+--------------|    |--------------+--------------+--------------|
  ),
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =
{
  ...
  //|--------------+--------------+--------------+--------------+--------------+--------------|                                  |--------------+--------------+--------------+--------------+------------------+------------------|
              KC_NO,       KC_BSLS,    RALT(KC_7),       KC_LBRC,    LSFT(KC_9),    RALT(KC_9),                                      KC_KP_SLASH,      KC_MINUS,RALT(KC_COMMA),  RALT(KC_DOT),          KC_EQUAL,             KC_NO,
  //|--------------+--------------+--------------+--------------+--------------+--------------|                                  |--------------+--------------+--------------+--------------+-----------------+------------------|
              KC_NO, RALT(KC_LBRC),    RALT(KC_8),       KC_RBRC,    LSFT(KC_0),    RALT(KC_0),                                   LSFT(KC_GRAVE),LSFT(KC_MINUS),     KC_COLON ,LSFT(KC_COLON),          KC_QUOTE,             KC_NO,
  //|--------------+--------------+--------------+--------------+--------------+--------------+--------------|    |--------------+--------------+--------------+--------------+--------------+------------------+------------------|
                                                                        KC_TRNS,       KC_TRNS,       KC_TRNS,            KC_TRNS,       KC_TRNS,         MO(5)
  //                                                            |--------------+--------------+--------------|    |--------------+--------------+--------------|
  ),
